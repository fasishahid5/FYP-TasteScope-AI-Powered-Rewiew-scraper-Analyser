...
export const getStoredUser = () => {
  ...
  try {
    ...
    // Include the token in the returned user object for service helpers.
...
// This clears any stale auth state and sends the user back to login.
// It is used when the backend says a token is invalid or expired.
export const handleExpiredAuthSession = (redirectPath = '/login') => {
  clearStoredAuth();
